  ...
  return (
    <>
      <div className="mt-[1.31rem] flex flex-col px-[0.88rem]">
        ...
        <div className="mt-[0.88rem] text-[0.9375rem] font-semibold">
          장윤정
        </div>
        <div className="mt-[0.62rem] text-xs">안녕하세요!!</div>
        <div className="mt-5 flex w-full items-center justify-center rounded-[0.625rem] bg-Gray300 px-[3.81rem] py-[0.625rem] font-medium">
          Edit Your Profile
        </div>
      </div>
    </>
